        ...
        <script>
            $(document).ready(function() {
               $('#channel').change(function() {
                   location.href = '<?php echo base_url() ?>setting/index/' + $('#channel').val();
               }); 
            });
        </script>
    </head>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="arpu_limit" name="arpu_limit" placeholder="ARPU Lowest Limit" value="<?php echo $row_setting['arpu_limit'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="cpi_limit" class="col-sm-2 control-label" style="text-align: left;">CPI Highest Limit ($)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="cpi_limit" name="cpi_limit" placeholder="CPI Highest Limit ($)" value="<?php echo $row_setting['cpi_limit'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="ppu_limit" class="col-sm-2 control-label" style="text-align: left;">PPU Lowest Limit (%)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="ppu_limit" name="ppu_limit" placeholder="PPU Lowest Limit (%)" value="<?php echo $row_setting['ppu_limit'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="d1_limit" class="col-sm-2 control-label" style="text-align: left;">D1 Lowest Limit (%)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="d1_limit" name="d1_limit" placeholder="D1 Lowest Limit (%)" value="<?php echo $row_setting['d1_limit'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="d3_limit" class="col-sm-2 control-label" style="text-align: left;">D3 Lowest Limit (%)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="d3_limit" name="d3_limit" placeholder="D3 Lowest Limit (%)" value="<?php echo $row_setting['d3_limit'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="d7_limit" class="col-sm-2 control-label" style="text-align: left;">D7 Lowest Limit (%)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="d7_limit" name="d7_limit" placeholder="D7 Lowest Limit (%)" value="<?php echo $row_setting['d7_limit'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-2">
