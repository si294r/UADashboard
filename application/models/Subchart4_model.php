...
class Subchart4_model extends CI_Model {
    ...
    public function get_start_date() {
        return isset($_SESSION['grid4_start_date']) ? $_SESSION['grid4_start_date'] : date('Y-m-d', strtotime("-7 days"));
    }

    public function get_end_date() {
        return isset($_SESSION['grid4_end_date']) ? $_SESSION['grid4_end_date'] : date('Y-m-d', strtotime("-1 days"));
    }

    public function get_referrer_name()
    {
        return isset($_SESSION['referrer_name4']) ? $_SESSION['referrer_name4'] : '';
    }

    public function get_campaign_name()
    {
        return isset($_SESSION['campaign_name4']) ? $_SESSION['campaign_name4'] : '';
    }
    
    public function set_data_AFSiteID($value) {
        $_SESSION['chart_data_AFSiteID4'] = $value;
    }

    public function get_data_AFSiteID() {
        return isset($_SESSION['chart_data_AFSiteID4']) ? $_SESSION['chart_data_AFSiteID4'] : [];
    }
...
from data_chart_AFSiteID_almighty15 dcf
