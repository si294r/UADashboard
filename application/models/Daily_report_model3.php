...
class Daily_report_model3 extends CI_Model {
    ...
    {
        $_SESSION['daily_report_country3'] = $v;
    }
    
    public function get_arr_country()
    {
        if (!isset($_SESSION['daily_report_arr_country3'])) {
            $this->load->database();
            $query = $this->db->query("select * from data_ua_country_almighty order by user_country");        
            $_SESSION['daily_report_arr_country3'] = $query->result_array();
        }
        return $_SESSION['daily_report_arr_country3'];
    }
    
    public function get_country()
    {
        return isset($_SESSION['daily_report_country3']) ? $_SESSION['daily_report_country3'] : "ALL";
    }
    ...
    {
        $_SESSION['daily_report_start_date3'] = $v;
    }
    
    public function get_start_date()
    {
        return isset($_SESSION['daily_report_start_date3']) ? $_SESSION['daily_report_start_date3'] : date('Y-m-d', strtotime("-7 days"));
    }
    
    public function set_end_date($v)
    {
        $_SESSION['daily_report_end_date3'] = $v;
    }
    
    public function get_end_date()
    {
        return isset($_SESSION['daily_report_end_date3']) ? $_SESSION['daily_report_end_date3'] : date('Y-m-d', strtotime("-1 days"));
    }
