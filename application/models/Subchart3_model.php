...
class Subchart3_model extends CI_Model {
    ...
    {
        return isset($_SESSION['referrer_name3']) ? $_SESSION['referrer_name3'] : '';
    }

    public function get_campaign_name()
    {
        return isset($_SESSION['campaign_name3']) ? $_SESSION['campaign_name3'] : '';
    }
    
    public function set_data_AFSiteID($value) {
        $_SESSION['chart_data_AFSiteID3'] = $value;
    }

    public function get_data_AFSiteID() {
        return isset($_SESSION['chart_data_AFSiteID3']) ? $_SESSION['chart_data_AFSiteID3'] : [];
    }
